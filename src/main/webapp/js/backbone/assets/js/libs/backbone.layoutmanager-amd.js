...
var layoutmanager = (function(Backbone, _, $) {
...
// Backbone.Layoutmanager AMD wrapper with namespace fallback
if (typeof define === 'function' && define.amd) {
    console.log("Starting LM as AMD");
    // AMD support
    define([
      ...
      'jquery'       // AMD supported
        ...
        return layoutmanager(Backbone, _, $);
      });
} else {
    console.log("Starting LM as NORMAL");
    // No AMD, use Backbone namespace
    root.Backbone = Backbone || {};
    root.Backbone.LayoutManager = layoutmanager(Backbone, _, jQuery);
}
