...
case class Project(@Key("_id") id: Option[ObjectId], name: String, description: String, cultureUrl: Option[String], enabled: Boolean, parent: Option[ObjectId] = None, @Ignore timestamp: Option[Date] = Some(new Date()))
object Project {
